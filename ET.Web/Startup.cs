...
using ET.Web.Application.Behaviors;
using ET.Web.Application.Commands;
using ET.Web.Application.Query;
using ET.Web.Application.Seed;
using MediatR;
...
namespace ET.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<IUserInGroupRepository, UserInGroupRepository>();
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env, IdentitySeed ensureMigration)
        {
            ensureMigration.EnsureMigrationOfContext().Wait();
